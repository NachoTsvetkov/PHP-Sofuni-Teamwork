...
if (isset($_POST['registerSubmit'])) {
	...
	$check = $user -> check_user(mysqli_real_escape_string($_POST['email']), $db);
	...
	if ($check) {
		...
		$user_name = mysqli_real_escape_string($_POST['username']);
		$user_email = mysqli_real_escape_string($_POST['email']);
		$user_password = mysqli_real_escape_string($_POST['password']);
